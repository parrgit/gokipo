<template>
  ...
  >
    ...
    <img
      ...
      style="width:100%; height:100%;"
    />
    <p v-show="penaltyTop.type === 'yes' || penaltyTop.type === 'no'">
      {{ penaltyTop.species }}
    </p>
  </div>
</template>
